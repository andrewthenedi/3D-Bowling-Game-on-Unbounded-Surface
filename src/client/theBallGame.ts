...
export default class TheBallGame {
    ...
    //marble path
    marble_0 = 'img/marble.png'
    marble_1 = 'img/marble_1.png'
    // jewel_0 = 'img/jewel.png'
    // jewel_1 = 'img/jewel_1.png'
    ...
    constructor(
        ...
        this.sphereMaterial = new THREE.MeshBasicMaterial({
            map: new THREE.TextureLoader().load(this.marble_1),
                        ...
                        ;(child as THREE.Mesh).material =
                            new THREE.MeshMatcapMaterial({
                                matcap: new THREE.TextureLoader().load(
                                    'img/green-mosaic-background_HK.jpg'
                                ),
                            })
                    }
                })
